...
var AppComponent = /** @class */ (function () {
    function AppComponent(_infoPagina, ProductosService) {
...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(infoServices) {
...
var ProductosService = /** @class */ (function () {
    ...
    ProductosService.prototype.cargarProductos = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.get('https://angular-html-ec955.firebaseio.com/productos_idx.json')
                .subscribe(function (resp) {
